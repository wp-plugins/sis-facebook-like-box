...
* Search for 'SIS Facebook Like Box' a plugin will come called 'SIS Facebook Like Box by Sayful Islam' and Click 'Install Now' and confirm your installation by clicking 'ok'
...
* From here, browse for the zip file included in your plugin titled 'sis-fb-like-box.zip' and click the 'Install Now' button
